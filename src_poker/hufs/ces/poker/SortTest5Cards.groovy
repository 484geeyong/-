...
class SortTest5Cards {
	...
	static void sortTest5Cards() {
		...
		Card[] fourCards = [new Card(1,1), new Card(2,1), new Card(3,1), new Card(4,1), new Card(1,2)];
		...
		Card[] straightflu = [new Card(1,1), new Card(1,2), new Card(1,3), new Card(1,4), new Card(1,5)];
		...
		//List<FiveCards> list5cardSorted1 =new QuickSort(list5cardSorted ).sort(new SimpleFiveCardsComparator1());
//		List<FiveCards> list5cardSorted2 =new QuickSort(list5cardSorted1).sort(new SimpleFiveCardsComparator2());


		println "FiveCards after Sort";
		printFiveCardsList(list5cardSorted);
		//printFiveCardsList(list5cardSorted2);
